...
/**
 *  @author liujinliang, 15-12-09 12:12:30
 *
 *  解决快带换行光标闪的问题
 *
...
- (void)refreshTextViewSize:(UITextView *)textView
{
    CGSize size = [self getStringRectInTextView:textView.text InTextView:textView];//[textView sizeThatFits:CGSizeMake(CGRectGetWidth(textView.frame), MAXFLOAT)];
//    if (self.autoAdpterRect && (size.height > CGRectGetHeight(textView.frame)))
//    {
