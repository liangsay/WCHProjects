...
+ (NSString *)jumpToBizPayWithOrder:(NSDictionary *)orderDic {
    ...
    NSString *urlString   = [NSString stringWithFormat:@"%@OrdertoPay.shtml",apiBaseURLString];//@"http://wxpay.weixin.qq.com/pub_v2/app/app_pay.php?plat=ios";
        ...
        NSError *error;
        //加载一个NSURL对象
        NSURLRequest *request = [NSURLRequest requestWithURL:[self URLWithBaseString:urlString parameters:orderDic]];
